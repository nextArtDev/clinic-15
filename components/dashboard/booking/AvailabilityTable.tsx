...
const AvailabilityTable: FC<AvailabilityTableProps> = ({ doctors }) => {
  ...
  function onSubmit(data: z.infer<typeof FormSchema>) {
    ...
    createAvailability({ days, doctorId: data.doctorId, slicer: data.slicer })
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4  ">
        <section className=" rounded-lg py-6 px-2  max-w-md mx-auto">
              ...
              render={({ field }) => (
                <FormItem className="col-span-2">
                  ...
                  >
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue className="" placeholder="بازه" />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
          ...
          <Button
            disabled={!isAnyDaySelected(selectedDays)}
